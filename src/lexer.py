...
class Lexer:
    ...
    def _getIdentifierTypeBasedOn(self, previousLexemeType):
        variableIdentifierPrecedingLexemeTypes = [
            ...
            STATEMENT.ADDITION_OPERATION,
            STATEMENT.SUBTRACTION_OPERATION,
            STATEMENT.MULTIPLICATION_OPERATION,
            STATEMENT.QUOTIENT_OPERATION,
            STATEMENT.MODULO_OPERATION,
            STATEMENT.MAX_OPERATION,
            STATEMENT.MIN_OPERATION,
            STATEMENT.AND_OPERATION,
            STATEMENT.OR_OPERATION,
            STATEMENT.XOR_OPERATION,
            STATEMENT.NOT_OPERATION,
            STATEMENT.INFINITE_ARITY_AND_OPERATION,
            STATEMENT.INFINITE_ARITY_OR_OPERATION,
            STATEMENT.EQUAL_TO_OPERATION,
            STATEMENT.NOT_EQUAL_TO_OPERATION,
            STATEMENT.CONCATENATION_OPERATION,
            STATEMENT.EXPLICIT_TYPECASTING_KEYWORD,
            STATEMENT.OPERAND_SEPARATOR,
            STATEMENT.OUTPUT_KEYWORD,
            STATEMENT.INPUT_KEYWORD,
            STATEMENT.CASE_KEYWORD,
            STATEMENT.KEYWORD_IN_LOOP,
            STATEMENT.LOOP_CONDITION_KEYWORD,
        ]

        loopIdentifierPrecedingLexemeTypes = [
            STATEMENT.LOOP_DECLARATION_AND_DELIMITER,
            STATEMENT.LOOP_DELIMITER,
        ]
